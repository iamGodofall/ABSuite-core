...
1038 tests. 130 API endpoints. 8 npm packages on npm. 5 HTTP services and the room,
...
Nobody adopts a project because it has 1038 tests. They adopt it because they
