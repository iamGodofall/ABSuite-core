...
963 tests. 128 API endpoints. 8 npm packages on npm. 5 HTTP services and the room,
...
Nobody adopts a project because it has 963 tests. They adopt it because they
